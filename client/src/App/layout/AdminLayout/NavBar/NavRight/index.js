                        ...
                        <Dropdown alignRight={!this.props.rtlLayout} className="drp-user">
                            ...
                            <Dropdown.Menu alignRight className="profile-notification">
                                <div className="pro-head">
                                    ...
                                    <span>Customer</span>
                                    <a href={DEMO.BLANK_LINK} className="dud-logout" title="Logout" onClick={this.logoutMe}>
                                        <i className="feather icon-log-out" />
                                    </a>
                                </div>
                                <ul className="pro-body">
                                    <li><Link to={'/LoginSetting'} className="dropdown-item"><i className="feather icon-settings" /> Settings</Link></li>
                                    <li><Link to={'/busniessSetup'} className="dropdown-item"><i className="feather icon-user" /> Profile</Link></li>
                                </ul>
                            </Dropdown.Menu>
                        </Dropdown>
                    </li>
